...
CREATE TABLE IF NOT EXISTS `contato` (
  ...
  KEY `fk_contato_telefone1_idx` (`id_telefone`),
  KEY `fk_contato_fornecedor1_idx` (`id_fornecedor`),
  KEY `fk_contato_tipo_contato1_idx` (`id_tipo_contato`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 AUTO_INCREMENT=1 ;
...
--
-- Table structure for table `departamento_has_fornecedor`
--

CREATE TABLE IF NOT EXISTS `departamento_has_fornecedor` (
  `id_departamento_has_fornecedor` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `endereco` (
  ...
  `tipo` tinyint(1) DEFAULT NULL COMMENT '0 - apartamento\n1 - casa\n2 - comercial',
...
(79, 'Gana'),
(80, 'Geórgia'),
(81, 'Geórgia do Sul e Ilhas Sandwich do Sul'),
(82, 'Gibraltar'),
(83, 'Granada'),
(84, 'Grécia'),
(85, 'Groênlandia'),
...
(96, 'Holanda'),
(97, 'Honduras'),
(98, 'Hong Kong, RAE da China'),
(99, 'Hungria'),
(100, 'Iêmen'),
(101, 'Ilha Bouvet'),
(102, 'Ilha de Man'),
(103, 'Ilha Heard e Ilhas McDonald'),
(104, 'Ilha Norfolk'),
(105, 'Ilhas Aland'),
(106, 'Ilhas Caiman'),
(107, 'Ilhas Coco'),
(108, 'Ilhas Cook'),
(109, 'Ilhas Distantes dos EUA'),
(110, 'Ilhas Faroe'),
(111, 'Ilhas Malvinas'),
...
(115, 'Ilhas Pitcairn'),
(116, 'Ilhas Salomão'),
(117, 'Ilhas Turks e Caicos'),
(118, 'Ilhas Virgens Britânicas'),
(119, 'Ilhas Virgens dos EUA'),
(120, 'Índia'),
(121, 'Indonésia'),
(122, 'Irã'),
(123, 'Iraque'),
...
(187, 'Quiribati'),
(188, 'Reino Unido'),
(189, 'República Centro-Africana'),
(190, 'República Dominicana'),
(191, 'República dos Camarões'),
(192, 'República Tcheca'),
(193, 'Reunião'),
(194, 'Romênia'),
(195, 'Ruanda'),
(196, 'Rússia'),
...
(203, 'Santa Lúcia'),
(204, 'São Bartolomeu'),
(205, 'São Cristovão e Nevis'),
(206, 'São Martinho'),
(207, 'São Tomé e Príncipe'),
(208, 'São Vicente e Granadinas'),
(209, 'Senegal'),
(210, 'Serra Leoa'),
(211, 'Sérvia'),
(212, 'Seychelles'),
...
(221, 'Suíça'),
(222, 'Suriname'),
(223, 'Svalbard e Jan Mayen'),
(224, 'Tadjiquistão'),
(225, 'Tailândia'),
(226, 'Taiwan'),
(227, 'Tanzânia'),
(228, 'Território Britânico do Oceano Índico'),
(229, 'Territórios Franceses do Sul'),
(230, 'Territórios palestinos'),
(231, 'Timor-Leste'),
(232, 'Togo'),
(233, 'Tokelau'),
(234, 'Tonga'),
(235, 'Trinidad e Tobago'),
(236, 'Tunísia'),
(237, 'Turcomenistão'),
(238, 'Turquia'),
(239, 'Tuvalu'),
...
CREATE TABLE IF NOT EXISTS `pessoa_has_endereco` (
  `id_pessoa_has_endereco` int(11) NOT NULL AUTO_INCREMENT,
  `id_pessoa_fisica` int(11) DEFAULT NULL,
  `id_pessoa_juridica` int(11) DEFAULT NULL,
  `id_endereco` int(11) NOT NULL,
  `preferencial` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id_pessoa_has_endereco`),
...
--
-- Table structure for table `pessoa_has_telefone`
--

CREATE TABLE IF NOT EXISTS `pessoa_has_telefone` (
  `id_pessoa_has_telefone` int(11) NOT NULL AUTO_INCREMENT,
  `id_pessoa_fisica` int(11) DEFAULT NULL,
  `id_pessoa_juridica` int(11) DEFAULT NULL,
  `id_telefone` int(11) NOT NULL,
  `preferencial` tinyint(1) DEFAULT '0',
  PRIMARY KEY (`id_pessoa_has_telefone`),
...
ALTER TABLE `pessoa_has_endereco`
  ADD CONSTRAINT `fk_pessoa_has_endereco_endereco1` FOREIGN KEY (`id_endereco`) REFERENCES `endereco` (`id_endereco`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pessoa_has_endereco_pessoa_fisica1` FOREIGN KEY (`id_pessoa_fisica`) REFERENCES `pessoa_fisica` (`id_pessoa_fisica`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_pessoa_has_endereco_pessoa_juridica1` FOREIGN KEY (`id_pessoa_juridica`) REFERENCES `pessoa_juridica` (`id_pessoa_juridica`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `pessoa_has_telefone`
--
ALTER TABLE `pessoa_has_telefone`
