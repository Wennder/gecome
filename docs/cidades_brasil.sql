...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 22, 2013 at 06:42 PM
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=5565 ;
...
CREATE TABLE IF NOT EXISTS `estado` (
  ...
  `nome` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  `uf` varchar(5) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `pais` (
  ...
  `nome` varchar(255) COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id_pais`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci AUTO_INCREMENT=251 ;
